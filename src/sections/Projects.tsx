  ...
  return (
    <section id="projects" className="py-16 bg-white dark:bg-[#020817]">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12 animate-on-scroll opacity-0 transition-opacity duration-700 ease-in-out">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={project.id}
              className={`animate-on-scroll opacity-0 transition-opacity duration-700 delay-${
                (index + 1) * 100
              } ease-in-out`}
            >
